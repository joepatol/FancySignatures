...
class IntMin(Min[int]): pass
class FloatMin(Min[float]): pass
class NumericMin(Min[float | int]): pass
class IntMax(Max[int]): pass
class FloatMax(Max[float]): pass
class NumericMax(Max[float | int]): pass
