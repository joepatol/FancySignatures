from typing import Any, TypeAlias, _alias
...
from .aliases import handle_alias_type_hints
...
def typecaster_factory(type_hint: TypeAlias) -> TypeCaster:
    ...
    # elif isinstance(type_hint, _alias):
    #     return handle_alias_type_hints(type_hint)
